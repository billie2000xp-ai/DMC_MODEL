...
struct PerfPriInfo {
    ...
    PerfPriInfo(unsigned bg_pri, unsigned rowhit_pri, unsigned ori_pri, unsigned bg_num, unsigned bank_num,
        unsigned rank_pri, unsigned state_pri)
    {
        m_bg_pri     = bg_pri;
    ...
    bool operator== (PerfPriInfo other)
    {
        return (m_ori_pri == other.m_ori_pri && m_rowhit_pri == other.m_rowhit_pri && m_bg_pri == other.m_bg_pri &&
                m_bank_num  == other.m_bank_num && m_bg_num == other.m_bg_num && m_rank_pri == other.m_rank_pri &&
...
public: 
    ...
    inline unsigned rcmd_num()
    {
        return rcmd_cnt;
    }
    inline unsigned wcmd_num()
    {
        return wcmd_cnt;
    }
    unsigned get_max_rank(bool isRd);
    unsigned GetPerfQsize()
    {
        return (rcmd_cnt + wcmd_cnt + rel_wcmd_cnt + rel_rcmd_cnt);
    };
...
private: 
    ...
    bool returnReadDataResp(unsigned int channel_num, unsigned long long task, double readDataEnterDmcTime,
